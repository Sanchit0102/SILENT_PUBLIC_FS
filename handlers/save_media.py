...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        await editable.edit(
            f"**Batch Files Stored in my Database!**\n\nHere is the Link of your files: <i><blockquote>{share_link}</blockquote></i> \n\n"
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        await forwarded_msg.reply_text(
            ...
            disable_web_page_preview=True)
        share_link = f"https://telegram.me/{Config.BOT_USERNAME}?start=PUBLIC_{str_to_b64(file_er_id)}"
        ...
        await editable.edit(
            ...
            f"Here is the Link of your file: <i><blockquote>{share_link}</blockquote></i> \n\n"
